...
//
//            reservation1 = new TicketReservation(2, BookingStatus.CONFIRMED);
//            reservation1.assignClient(client1);
//            reservation1.assignEvent(event1);
//
...
//            entityManager.persist(event1);
//
//            reservation1 = TicketReservation.createForTesting(1, BookingStatus.PENDING_CONFIRMATION,
//                    now.minusDays(2), now.minusDays(1));
//            reservation2 = TicketReservation.createForTesting(2, BookingStatus.CONFIRMED,
//                    now.minusDays(1), now);
//            reservation3 = TicketReservation.createForTesting(3, BookingStatus.CANCELED,
//                    now, now);
//
//            reservation1.assignClient(client1);
//            reservation1.assignEvent(event1);
//            reservation2.assignClient(client1);
//            reservation2.assignEvent(event1);
//            reservation3.assignClient(client1);
//            reservation3.assignEvent(event1);
//
//            entityManager.persist(reservation1);
