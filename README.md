...
* **Docker Compose** — для управления двумя контейнерами, автоматического их запуска и обеспечения их взаимодействия
...
## Демонстрация работы фронтенда
Ниже представлена гифка, показывающая процесс бронирования билетов на мероприятие в пользовательском интерфейсе:

![Демонстрация фронтенда](images/frontend.gif)

## Схема базы данных
Ниже представлена схема базы данных для данного приложения:

![Схема базы данных](images/schema.png)

Схема иллюстрирует таблицы паспортов, клиентов, мероприятий, бронирований и связи между ними.
